...
TextRenderer::TextRenderer(std::size_t width, std::size_t height, std::size_t fontSize) :
    textShader(Shader("shader/TextRenderingVShader.glsl", "shader/TextRenderingFShader.glsl"))
{
    FT_Library ft;
